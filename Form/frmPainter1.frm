...
Begin VB.Form frmPaint 
   ...
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   0  'None
   Caption         =   "Munching Draw"
   ClientHeight    =   7320
   ClientLeft      =   5880
   ClientTop       =   -7320
   ClientWidth     =   7455
   Icon            =   "frmPainter1.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7320
   ScaleWidth      =   7455
   ...
   Begin VB.PictureBox fraColor 
      ...
      Top             =   6420
      Width           =   7095
      Begin vbPainter.XandersXPTaskBar XandersXPTaskBar1 
         Left            =   4230
         Top             =   15
         _ExtentX        =   847
         _ExtentY        =   847
   ...
   Begin VB.PictureBox picPaint 
      ...
      Begin vbPainter.TransPicBox TransPicBox1 
         ...
         Left            =   0
         TabIndex        =   75
         ToolTipText     =   "Element 1"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":4215
      End
      Begin vbPainter.TransPicBox TransPicBox10 
         Height          =   1800
         Left            =   0
         TabIndex        =   84
         ToolTipText     =   "Element 10"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":11647
      End
      Begin vbPainter.TransPicBox TransPicBox9 
         Height          =   1800
         Left            =   0
         TabIndex        =   83
         ToolTipText     =   "Element 9"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":1EA79
      End
      Begin vbPainter.TransPicBox TransPicBox8 
         Height          =   1800
         Left            =   0
         TabIndex        =   82
         ToolTipText     =   "Element 8"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":2BEAB
      End
      Begin vbPainter.TransPicBox TransPicBox7 
         Height          =   1800
         Left            =   0
         TabIndex        =   81
         ToolTipText     =   "Element 7"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":392DD
      End
      Begin vbPainter.TransPicBox TransPicBox5 
         Height          =   1800
         Left            =   0
         TabIndex        =   79
         ToolTipText     =   "Element 5"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":4670F
      End
      Begin vbPainter.TransPicBox TransPicBox6 
         Height          =   1800
         Left            =   0
         TabIndex        =   80
         ToolTipText     =   "Element 6"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":53B41
      End
      Begin vbPainter.TransPicBox TransPicBox4 
         Height          =   1800
         Left            =   0
         TabIndex        =   78
         ToolTipText     =   "Element 4"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":60F73
      End
      Begin vbPainter.TransPicBox TransPicBox3 
         Height          =   1800
         Left            =   0
         TabIndex        =   77
         ToolTipText     =   "Element 3"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":6E3A5
      End
      Begin vbPainter.TransPicBox TransPicBox2 
         Height          =   1800
         Left            =   0
         TabIndex        =   76
         ToolTipText     =   "Element 2"
         Top             =   0
         Visible         =   0   'False
         Width           =   2250
         _ExtentX        =   3969
         _ExtentY        =   3175
         Picture         =   "frmPainter1.frx":7B7D7
      End
      ...
      Begin VB.Menu mnuFile 
         ...
         Begin VB.Menu mnuOE 
            ...
            Begin VB.Menu mnu1 
               ...
               Index           =   10
            End
            Begin VB.Menu mnuCropPic 
               Caption         =   "Crop Picture Selection"
               Visible         =   0   'False
            End
         End
...
picPaint.PaintPicture picPaint.Picture, 0, 0, Picture1.ScaleWidth, Picture1.ScaleHeight
picPaint.Height = Picture1.Height
picPaint.Width = Picture1.Width
End Sub
...
Exit Sub
    ...
    If Image1.Width + 2000 <= Screen.Width Then
        If Image1.Width > 6225 Then
            Me.Width = Image1.Width + 2000
        End If
    Else
        Me.Width = Screen.Width
    End If
    
    If Image1.Height + 2000 <= Screen.Height Then
        If Image1.Height > 6030 Then
            Me.Height = Image1.Height + 2000
        End If
    Else
...
Public Sub Form_Resize()
 ...
 On Error Resume Next
  ...
  If Me.WindowState <> vbMinimized Then
    ...
    fraColor.Top = Me.ScaleHeight - 900
    ...
    End If
  End If
  'Me.Width = picPaint.Width + picPaint.Left + 1
Exit Sub
  
If Me.Height > 8250 Then
    Me.Height = picPaint.Height + 2650
Else
    Me.Height = 8250
End If
If Me.Width > 7620 Then
    Me.Width = picPaint.Width + 1350
Else
    Me.Width = picPaint.Width + picPaint.Left + 1  '7620
End If
...
Private Sub Form_Unload(Cancel As Integer)
  ...
  'End If
    ...
    'SavePicture picPaint.Image, ThePicture
    'Open App.Path & "\VbPaint" For Output As #1
        'Print #1, ThePicture
    'Close #1
    Captured = False
If Outahere = True Then GoTo Outa
If Element <> 0 Then
...
Private Sub mnuPasteTrans_Click()
Element = Element + 1
If Element = 11 Then
    Element = 10
    MsgBox "Only 10 Elements may be added at once! Merge and Re-load"
...
GoTo heeer
  If blnMovingT = True Then
    If X <> 0 Then
        Select Case Element
          Case 1
            TransPicBox1.Left = X + 1
          Case 2
          Case 3
          Case 4
          Case 5
    ...
    Else
        Select Case Element
          ...
          Case 9
            TransPicBox9.Left = X
          Case 10
            TransPicBox10.Left = X
        End Select
    End If
    If Y <> 0 Then
        Select Case Element
          Case 1
            TransPicBox1.Top = Y + 1
          Case 2
            TransPicBox2.Top = Y + 1
          Case 3
            TransPicBox3.Top = Y + 1
          Case 4
            TransPicBox4.Top = Y + 1
          Case 5
            TransPicBox5.Top = Y + 1
          Case 6
            TransPicBox6.Top = Y + 1
          Case 7
            TransPicBox7.Top = Y + 1
          Case 8
            TransPicBox8.Top = Y + 1
          Case 9
            TransPicBox9.Top = Y + 1
          Case 10
            TransPicBox10.Top = Y + 1
        End Select
    Else
        Select Case Element
          Case 1
